...
VALUES
('admin', '$2a$11$pgj3.zySyFOvIQEpD7W6Aund1Tw.BFarXxgLJxLbrzIv/4Nteisii', 'Admin', 'admin@example.org', true);

INSERT INTO users
(username, password, name, email, admin)
VALUES
('nn', '$2a$11$pgj3.zySyFOvIQEpD7W6Aund1Tw.BFarXxgLJxLbrzIv/4Nteisii', 'Nafnlaus', 'nn@example.org', false);
